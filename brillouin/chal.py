...
class Threshold:
  ...
  def chester_sign(self):
    tosign = str(raw_input(('you want me to sign what? you sure this is legal? are you with the atf? the fda? are you high right now? do you ever get nervous?\n')))
    print('ok, sure')
  ...
  def dispatch(self):
    i = int(raw_input('what do you want to do? (1) talk to Abe, (2) talk to Bernie, (3) talk to C-money, (4) see the flag\n'))
    if i == 1:
      self.abe_sign()
      self.dispatch()
    elif i == 2:
